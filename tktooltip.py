...
if __name__ == '__main__':
    ...
    def main_01(wraplength=200):
        ...
        btn_ne = tk.Button(frame, text='North East')
        btn_se = tk.Button(frame, text='South East')
        btn_sw = tk.Button(frame, text='South West')
        btn_nw = tk.Button(frame, text='North West')
        btn_center = tk.Button(frame, text='Center')
        btn_n = tk.Button(frame, text='North')
        btn_e = tk.Button(frame, text='East')
        btn_s = tk.Button(frame, text='South')
        btn_w = tk.Button(frame, text='West')
